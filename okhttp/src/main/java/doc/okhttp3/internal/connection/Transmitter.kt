 ...
 */
package doc.okhttp3.internal.connection

import doc.okhttp3.Address
import okhttp3.Call
...
class Transmitter(
  ...
  private fun createAddress(url: HttpUrl): doc.okhttp3.Address {
    ...
    return doc.okhttp3.Address(url.host, url.port, client.dns(), client.socketFactory(),
