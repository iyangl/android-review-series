...
import doc.okhttp3.internal.toImmutableList
...
class Address(
  ...
  @get:JvmName("dns") val dns: doc.okhttp3.Dns,
  ...
  @get:JvmName("certificatePinner") val certificatePinner: doc.okhttp3.CertificatePinner?,

        /** Returns the client's proxy authenticator. */
  @get:JvmName("proxyAuthenticator") val proxyAuthenticator: doc.okhttp3.Authenticator,
  ...
  @get:JvmName("proxy") val proxy: Proxy?,
        ...
        protocols: List<doc.okhttp3.Protocol>,
        connectionSpecs: List<doc.okhttp3.ConnectionSpec>,
   ...
   */
  @get:JvmName("url") val url: doc.okhttp3.HttpUrl = doc.okhttp3.HttpUrl.Builder()
   ...
   */
  @get:JvmName("protocols") val protocols: List<doc.okhttp3.Protocol> = protocols.toImmutableList()

  @get:JvmName("connectionSpecs") val connectionSpecs: List<doc.okhttp3.ConnectionSpec> =
  ...
  override fun equals(other: Any?): Boolean {
    return other is doc.okhttp3.Address &&
        url == other.url &&
        equalsNonHost(other)
  }
  ...
  internal fun equalsNonHost(that: doc.okhttp3.Address): Boolean {
